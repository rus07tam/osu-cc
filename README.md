...
> Terms of Service, and your account is your responsibility. This project will
> never contain cheats or anything of that kind. Read
> [docs/en/SECURITY.md](docs/en/SECURITY.md) before using it.
...
![New personal best](docs/assets/NEW_SCORE_CELEBRATION.png)
...
- [Development (Core)](docs/en/DEVELOPMENT.md)
- [Development (Plugins)](docs/en/PLUGINS.md)
