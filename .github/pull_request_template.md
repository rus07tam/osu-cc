...
What this PR does and why. Link any related issues (e.g. `Closes #123`).
...
- [ ] English and Russian docs updated where relevant
- [ ] Tested against a real osu!lazer install (hook log + in-game)
